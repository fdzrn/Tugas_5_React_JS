...
class FormMakanan extends Component{
	...
	handleSubmit(e) {
		e.preventDefault();
		alert("Pesanan Kamu : " + this.state.pesanan + " | Jumlah Pesanan :" + this.state.jumlah);
			...
			<div>
				<center>
					<form onSubmit={this.handleSubmit} >
						<input type="text" placeholder="Masukan Pesanan" value={this.state.pesanan} ref={this.pesanan} onChange={this.handleChange} />
